...
int main(int argc, char *argv[])
{
	...
	/*
		query		sequence to be compared with reference for alignment
		reference	reference sequence for  SW algorithm
		sc_mat		score matrix for SW algorithm
		dir_mat		directions matrix for SW algorithm
	*/
